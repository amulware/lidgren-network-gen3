...
namespace Lidgren.Network
{
	...
	public partial class NetPeer
	{
		...
		// on user thread
        private NetSendResult SendFragmentedMessage(NetOutgoingMessage msg, IReadOnlyList<NetConnection> recipients, NetDeliveryMethod method, int sequenceChannel)
		{
